...
public class TestVOMSCommandsParser {
	...
	public void testEmpyCommandList() {
		...
		Map<String, List<String>> map = parser.parseCommands(Collections.<String> emptyList());
	...
	public void testSingleVOCommandList(){
		...
		Map<String, List<String>> map = parser.parseCommands(Arrays.asList("atlas"));
	...
	public void testSingleFQANCommandList(){
		...
		Map<String, List<String>> map = parser.parseCommands(Arrays.asList("atlas:/atlas/Role=production"));
	...
	public void testMultipleFQANsCommandList(){
		...
		Map<String, List<String>> map = parser.parseCommands(Arrays.asList("atlas:/atlas/Role=production", "atlas:/atlas/Role=admin"));
	...
	public void testMultipleFQANsWithRepeatedVOCommandList(){
		...
		Map<String, List<String>> map = parser.parseCommands(Arrays.asList("atlas:/atlas/Role=production", "atlas:/atlas/Role=admin", "atlas"));
	...
	public void testMultipleVOsCommandList(){
		...
		Map<String, List<String>> map = parser.parseCommands(Arrays.asList("atlas:/atlas/Role=production", "atlas:/atlas/Role=admin", "cms", "cms:/cms/camaghe"));
		Assert.assertNotNull(map);
		Assert.assertFalse(map.isEmpty());
	...
	public void testSupportForLegacyAllCommand(){
		...
		DefaultVOMSCommandsParser parser = new DefaultVOMSCommandsParser();
		Map<String, List<String>> map = parser.parseCommands(Arrays.asList("atlas:all"));

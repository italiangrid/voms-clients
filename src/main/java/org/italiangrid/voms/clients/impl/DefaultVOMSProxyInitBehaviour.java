...
public class DefaultVOMSProxyInitBehaviour implements ProxyInitBehaviour {
	...
	private void createProxy(ProxyInitOptions options, X509Credential credential, List<AttributeCertificate> acs){
	...
	protected List<AttributeCertificate> getAttributeCertificates(ProxyInitOptions options, X509Credential cred){
		...
		Map<String, List<String>> vomsCommandsMap = commandsParser.parseCommands(options.getVomsCommands());
